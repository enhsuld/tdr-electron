angular
    .module('altairApp')
    	.controller("fileCtrl",['$scope','$timeout','Upload','mainService','$state','sweet','__env',
	        function ($scope,$timeout,Upload,mainService,$state,sweet,__env) {       	
	        	...
	        	var progressbar = $("#file_upload-progressbar"),
	                ...
	                settings    = {
	                    ...
	                    action: __env.apiUrl()+'/api/file/upload/zagwarExcel', // upload url
					...
					$scope.deleteO = function(id){
					    ...
					    closeOnCancel: false
						 ...
						 if (inputvalue) {
							 ...
							 mainService.withdata('POST', __env.apiUrl()+'/core/delete/'+$scope.domain,  $scope.formdata).
								then(function(data){
					    			$(".k-grid").data("kendoGrid").dataSource.read(); 
	 		       ...
	 		       $scope.upload = function (file,fileAdmin,i,y) {
	 		    	   ...
	 		    	   console.log(i);
	 		    	   if(i!=0){
	 		    		   xurl =__env.apiUrl()+'/api/file/upload/zagwarExcel/'+$scope.aan+'/'+y;
	 		    	   }
	     			...
	     			$scope.fileGrid = {
 		                dataSource: {
 		                    ...
 		                    transport: {
 		                    	read:  {
 		                            url: __env.apiUrl()+"/core/list/FileUpload",
